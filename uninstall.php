...
// Une seule meta (_saito_faq_items, voir SAITO_FAQ_META_KEY dans saito-faq.php),
...
$wpdb->delete( $wpdb->postmeta, array( 'meta_key' => '_saito_faq_items' ) );
$wpdb->delete( $wpdb->termmeta, array( 'meta_key' => '_saito_faq_items' ) );
